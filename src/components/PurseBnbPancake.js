...
class PurseBnbPancake extends Component {
    ...
    return (
      <div id="content" className="mt-3">
        <div className="text-center">
          <ButtonGroup>
            <Button variant="contained" color="default" component={Link} to="/deposit/">pancakeswap</Button>
            <Button variant="outlined" color="default" component={Link} to="/oneinch/">1inch</Button>
          </ButtonGroup>
        </div>
        <br /><br />

        <h2 className="center"><b>PURSE-BNB Farm</b></h2>
        <br />
        <div className="center" style={{ color: 'grey' }}>&nbsp;Deposit <b>&nbsp;PURSE-BNB PANCAKE LP&nbsp;</b> and earn PURSE!!!</div>
        <div className="center" style={{ color: 'grey' }}>&nbsp;APY :  {(28000 * 365 * this.props.poolInfo[1].pursePerBlock / this.props.lpTokenInContract[1]) * 100} %</div>
        <br />
        ...
        <div className="card mb-4" >
          <div className="card-body">
            ...
            <button
              ...
              onClick={(event) => {
                ...
                if (this.props.pendingReward <= 0 ) {
                  alert("No token to harvest! Please deposit PURSE-BNB PANCAKE LP to earn PURSE")
                } else {
                  this.props.withdraw(1,0)
                }                
              }}>
              <small>Harvest</small>
            ...
            <table className="table table-borderless text-muted text-center">
              ...
              <tbody>
                <tr>
                  <td>{window.web3.utils.fromWei(this.props.userInfo[1].amount.toString(), 'Ether')}</td> 
                  <td>{window.web3.utils.fromWei(this.props.pendingReward[1], 'Ether')}</td>
                </tr>
              </tbody>
            </table>
                ...
                <form className="mb-3" onSubmit={(event) => {
                  ...
                  <div>
                    ...
                    <span className="float-right text-muted">
                      <span>
                        LP Balance &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {window.web3.utils.fromWei(this.props.lpTokenBalance[1], 'Ether')}</span>
                      <span><br />
...
export default PurseBnbPancake;
